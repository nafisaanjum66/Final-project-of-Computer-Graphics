...
// Group : 4 // Date : 24 December 2019 //

/*User Guide :
For top - bottom Road (Keyboard Needed):
    >> Press r/R for Red Signal
    >> Press y/Y for Yellow Signal
    >> Press g/G for Green Signal
For Left - Right Road (Mouse Control):
    >> Press Left Button For Red Signal
    >> Press Right Button for Green Signal
*/
...
GLfloat speed1 = 0.060f;
GLfloat speed2 = 0.025f;
...
glBegin(GL_QUADS);
   ...
   glBegin(GL_QUADS);
    ...
    glBegin(GL_TRIANGLES);
    glColor3ub(24,142,55);
    glVertex2f(0.85f, 0.73f);
    glVertex2f(1.0f, 0.73f);
    glVertex2f(0.925f, 0.86f);
    glVertex2f(0.85f, 0.76f);
    glVertex2f(1.05f, 0.76f);
    glVertex2f(0.928f, 0.93f);
...
glTranslatef(-.0f,-0.2f,0.0f);
 ...
 glTranslatef(-.015f,-0.12f,0.0f);
    ...
    //Front Building Right Sided Window
...
//Back Building Right sided Window
...
int main(int argc, char** argv) {
 ...
 printf("User Guide :\n");
 printf("For top - bottom Road (Keyboard):\n");
 printf("    >> Press r/R for Red Signal\n    >> Press y/Y for Yellow Signal\n    >> Press g/G for Green Signal\n");
 printf("For Left - Right Road (Mouse Control):\n");
 printf("    >> Press Left Button For Red Signal\n    >> Press Right Button for Green Signal\n");
